...
public class ElkGraphParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ElkGraphGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getElkNodeAccess().getAlternatives_2_3(), "rule__ElkNode__Alternatives_2_3");
			builder.put(grammarAccess.getElkPortAccess().getAlternatives_2_3(), "rule__ElkPort__Alternatives_2_3");
			...
			builder.put(grammarAccess.getElkNodeAccess().getLabelsAssignment_2_3_0(), "rule__ElkNode__LabelsAssignment_2_3_0");
			builder.put(grammarAccess.getElkNodeAccess().getPortsAssignment_2_3_1(), "rule__ElkNode__PortsAssignment_2_3_1");
			builder.put(grammarAccess.getElkNodeAccess().getChildrenAssignment_2_3_2(), "rule__ElkNode__ChildrenAssignment_2_3_2");
			builder.put(grammarAccess.getElkNodeAccess().getContainedEdgesAssignment_2_3_3(), "rule__ElkNode__ContainedEdgesAssignment_2_3_3");
			...
			builder.put(grammarAccess.getElkPortAccess().getLabelsAssignment_2_3_0(), "rule__ElkPort__LabelsAssignment_2_3_0");
			builder.put(grammarAccess.getElkPortAccess().getSubPortsAssignment_2_3_1(), "rule__ElkPort__SubPortsAssignment_2_3_1");
